...
$$ {\bar{v_{n}^2}} = \frac{4 k_B T R B}{e^{\frac{hf}{KT}-1}} $$
...
Para frecuencias bajas $hf << h f $ por lo tanto, $ e^{\frac{h f}{k_B T}} \approx \frac{h f}{k_B T} +1$ es por ello que la la densidad espectral se reduce a la expresión $N_{Res} = 4 k_B T R$.
...
Parametros del transistor: $r_{11} = 1 K\Omega$, $g_m    = 100 mS $, $r_{22} = 10 K\Omega $.
